...
if(isset($_SESSION["username"])){
		header("location:127.0.0.1:5000/".$_SESSION['username']."");
        ...
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="dellteam@vibhorein.com" name="username">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
